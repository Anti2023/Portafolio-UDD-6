...
const MenuSocial = () => {
    ...
    return (
        <div className="fixed bottom-0 z-30 flex flex-col items-center w-full mt-auto md:justify-center h-max md:top-1/4 md:left-5 md:w-16 md:max-w-md md:h-screen">
            <div
